...
export default defineConfig({
  ...
  fonts: [
    { provider: fontsource, name: 'Instrument Sans', cssVariable: '--font-instrument-sans', weights: ['400 700'], subsets: ['latin'], fallbacks: ['sans-serif'] },
    { provider: fontsource, name: 'Instrument Serif', cssVariable: '--font-instrument-serif', weights: [400], subsets: ['latin'], fallbacks: ['serif'] },
    { provider: fontsource, name: 'Martian Mono', cssVariable: '--font-martian-mono', weights: ['400 700'], subsets: ['latin'], fallbacks: ['monospace'] },
