...
| Style          | Looks like                                                     |
| -------------- | -------------------------------------------------------------- |
| `dither`        | Two offset dot grids, like a halftone print. The default, and the only style that stays in place while the page scrolls |
...
The `dither` style is anchored to the top left. Move it with `backdropPosition: 'center'` or `'right'`.
