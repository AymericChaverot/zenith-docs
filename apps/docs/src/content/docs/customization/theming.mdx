...
The default theme is neutral. Pick a colored accent with the `accent` option: `neutral`, `emerald`, `teal`, `amber`, `rose` or `violet`. Try them on the [kitchen sink](/writing/kitchen-sink/) page.

```js title="astro.config.mjs"
zenith({
  title: 'My Docs',
  accent: 'emerald', // [!code highlight]
});
```
