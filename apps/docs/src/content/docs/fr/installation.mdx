...
Cela suit la branche `main`. Ajoutez un tag de version pour la figer, comme `github:AymericChaverot/zenith-docs#v0.1.0` : les sites créés par `create` sont figés ainsi dès le départ.
