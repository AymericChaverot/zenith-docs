...
Cela suit la branche `main`. Ajoutez un tag de version pour la figer, comme `github:AymericChaverot/zenith-docs#v0.2.0` : les sites créés par `create` sont figés ainsi dès le départ.
